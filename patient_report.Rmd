...
```{r key_findings}
fname <- file.path(output_dir, "tier_classification", paste0("key_clinical_findings_output_", snv_caller, ".tsv"))
...
```{r all_findings}
fname <- file.path(output_dir, "tier_classification", paste0("all_findings_output_", snv_caller, ".tsv"))
if(file.exists(fname)){
...
fname <- file.path(output_dir, "rnaseq_analysis", "diffexpr_genes_barplot_output.pdf")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "rnaseq_analysis", "diffreg_pathways_barplot_output.pdf")
if(file.exists(fname)){
 knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "drug_recommendations", "ora_plots.pdf")
if(file.exists(fname)){
 knitr::include_graphics(fname) 
}
```
...
```{r tm_signature}
fname <- file.path(output_dir, "tmb_analysis", "tumor_signature_output.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "tmb_analysis", "tmb_profile_output.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "immune_analysis", "immune_scores_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "immune_analysis", "immune_scores_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "immune_analysis", "tis_scores.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "dim_reduction_plot_pediatric.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis",
...
fname <- file.path(output_dir, "survival_analysis", "kaplan_meier_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "immune_analysis", "immune_scores_topcor_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "ssgsea_scores_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "pathway_analysis_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_shared_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "lollipop_shared_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_recurrent_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "lollipop_recurrent_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_cnv_shared_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "dim_reduction_plot_adult.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "transciptomically_similar_adult.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "survival_analysis", "kaplan_meier_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "pathway_analysis_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_shared_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "lollipop_shared_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_recurrent_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "lollipop_recurrent_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_cnv_shared_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "transcriptomically_similar_analysis", "mutational_cnv_recurrent_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "genomic_landscape_plots", "circos_plot.png")
if(file.exists(fname)){
 knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "oncogrid_analysis", "complexheatmap_oncogrid.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "drug_recommendations", "transcriptome_drug_rec.rds")
if(file.exists(fname)){
...
fname <- file.path(output_dir, "drug_recommendations", "drug_dge_density_plots", 
...
fname <- file.path(output_dir, "drug_recommendations", "drug_pathways_barplot.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "drug_recommendations", "GTExBrain_dsea_go_mf_output.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "drug_recommendations", "PBTA_HGG_dsea_go_mf_output.pdf")
if(file.exists(fname)){
 knitr::include_graphics(fname) 
}
```
...
fname <- file.path(output_dir, "drug_recommendations", "PBTA_ALL_dsea_go_mf_output.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```
...
fname <- file.path(output_dir, "drug_synergy", "combined_qSig_synergy_score_top10.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname)
}
```