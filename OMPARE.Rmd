...
fname <- file.path(topDir, 'output', 'pathway_analysis_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_shared_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'lollipop_shared_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_recurrent_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'lollipop_recurrent_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_cnv_shared_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_cnv_recurrent_pediatric.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'pathway_analysis_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_shared_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'lollipop_shared_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_recurrent_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'lollipop_recurrent_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_cnv_shared_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(topDir, 'output', 'mutational_cnv_recurrent_adult.pdf')
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
