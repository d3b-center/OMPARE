...
mutational_analysis <- function(nn_tpm_input, ref_cancer_dir, all_findings_output, key_clinical_findings_output, clinical, comparison){
  
  # tpm matrix of top 20 nearest neighbors
  top20 <- colnames(nn_tpm_input)
