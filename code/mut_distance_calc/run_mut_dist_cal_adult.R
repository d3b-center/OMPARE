...
coseq_cluster_assignment <- file.path(patient_dir, "output", "coseq_detect", "adult", "cancer_group_of_interest_nb_cluster_assigned.tsv")
...
filtered_count_cg_coding_pval <- file.path(patient_dir, "output", "coseq_detect", "adult", "filtered_count_cg_coding_pval.rds")
...
nb_cluster_assigned <- file.path(patient_dir, "output", "mut_distance_calc", "adult", "patient_of_interest_nb_cluster_assigned.tsv")
