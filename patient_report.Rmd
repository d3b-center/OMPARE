...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "recurrent_mutations_lollipop_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "shared_mutational_cnv_pediatric.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "shared_mutations_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "shared_mutations_lollipop_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "recurrent_mutations_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "recurrent_mutations_lollipop_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "shared_mutational_cnv_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
...
fname <- file.path(patient_output_dir, "transcriptomically_similar_analysis", "recurrent_mutational_cnv_adult.pdf")
if(file.exists(fname)){
  knitr::include_graphics(fname) 
}
```
