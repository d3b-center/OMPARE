...
```{r drug_signatures_gtex, fig.width = 15, fig.height = 20}
...
```{r drug_signatures_pbta_hgg, fig.width = 15, fig.height = 20}
if(exists('drug_pathways_barplot')){
...
```{r drug_signatures_pbta, fig.width = 15, fig.height = 20}
if(exists('drug_pathways_barplot')){
