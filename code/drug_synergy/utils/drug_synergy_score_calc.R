...
results_dir <- file.path(root_dir, "code", "drug_synergy", "results", "synergy_score")
...
#### Define function that calculates synergy score -----------------------------------
# following functions adapted from SynGeNet Publication [@doi:10.1038/s41540-019-0085-4]
# Supplementary information downloadable as subUserFunctionsVa2.R
