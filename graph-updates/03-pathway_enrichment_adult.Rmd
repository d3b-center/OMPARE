---
title: "Pathway Analysis Adult Graph Conversion"
author: "Run Jin"
date: "8/24/2021"
...
plot_dir <- file.path(adult_dir, "pathway_barplot")
...
pathway_analysis_pediatric <- readRDS(file.path(data_dir, "pathway_analysis_adult.rds"))
...
ggsave(file.path(plot_dir, "pathway_analysis_adult.png"), height = 6, width = 15)
```   